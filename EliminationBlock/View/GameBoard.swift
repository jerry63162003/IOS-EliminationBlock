...
class GameBoard: UIView {
    ...
    static let cols = 10
    static let gap = 1
    static let brickSize = Int(UIScreen.main.bounds.size.width*(20/375.0))
    static let smallBrickSize = Int(UIScreen.main.bounds.size.width*(10/375.0))
...
//    static let height = GameBoard.brickSize * GameBoard.rows + GameBoard.gap * (GameBoard.rows+1)
    static let EmptyColor = UIColor.brown
